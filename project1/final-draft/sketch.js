...
function preload() {
  Bangers = loadFont("./fonts/Bangers-Regular.ttf", fontRead);
  Limelight = loadFont("./fonts/Limelight-Regular.ttf", fontRead);
  GeostarFill = loadFont("./fonts/GeostarFill-Regular.ttf", fontRead);
  Megrim = loadFont("./fonts/Megrim-Regular.ttf", fontRead);
  pointImg = loadImage("dada-imgs/pedro-unsplash.jpg");
...
function popArt(x, y, w, h, r, g, b, r2, g2, b2, r3, g3, b3) {
  ...
  text("ESC!", x + w / 6, h / 3 + textSize() / 3 + y, w);
}
...
function draw0() {
  ...
  noLoop();
    ...
    fill(255, 255, 153, 225);
    ellipse(width / 8, height / 8, height / 6, height / 6);
    if (fontReady) {
      textFont(GeostarFill);
    }
    fill(50, 50, 20, 150);
    textSize(width / 48)
    textAlign(CENTER);
    text("esc", 0, height / 7 -5, width / 4 + 5);
}

// -------------------------

// first styled Drawing
function draw1() {
  noLoop();
  ...
  stroke(0, 0, 0, 100);
  noFill();
  text("E", -62, height / 2 + textSize() / 3 + 5, width);
  text("S", 0, height / 2 + textSize() / 3 + 5, width);
  text("C", 67, height / 2 + textSize() / 3 + 5, width);
  stroke(255, 255, 255, 50);
  noStroke();
  fill(255, 220, 140);
  text("E", -60, height / 2 + textSize() / 3, width);
  text("S", 0, height / 2 + textSize() / 3, width);
  text("C", 65, height / 2 + textSize() / 3, width);
}
...
function draw2() {
  ...
  textAlign(CENTER);
  text("esc", 8, height / 2 + textSize() / 4 - 1, width);
}
...
function draw3() {
  ...
  textAlign(CENTER);
  text("Esc", 0, height / 2 + textSize() / 3, width);
  pop();
...
//resizes drawing when window is resized 
